...
import { Icon as DSIcon, type IconProps as DSIconProps } from '@alkitu/design-system/components/atoms/Icon';
...
export const Icon = React.forwardRef<SVGSVGElement, IconProps>(
  ({ migrated = false, name, size, color, className, ...props }, ref) => {
    if (migrated && name) {
      ...
      return <DSIcon ref={ref as any} name={name} size={size} color={color} className={className} {...props} />;
    }
