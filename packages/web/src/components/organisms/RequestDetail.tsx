...
const RequestDetail: React.FC<RequestDetailProps> = ({
  ...
  const primaryPhone =
    request.requester?.phone || request.requester?.contactPhone;
          ...
          <Card variant="vertical" title="">
            <div className="p-6">
              ...
              {request.templateFields &&
                Object.keys(request.templateFields).length > 0 && (
                  <div className="mt-6">
                    <Typography variant="h4" weight="medium" className="mb-3">
                      Información adicional
                    </Typography>
                    <div className="bg-neutral-100 p-4 rounded-lg space-y-2">
                      {Object.entries(request.templateFields).map(
                        ([key, value]) => (
              ...
              <div className="flex items-start justify-between mb-6">
                ...
                {viewType === 'admin' && editingField !== 'location' && (
                  <IconButton
                    ...
                    variant="ghost"
                    onClick={() =>
                      handleEdit('location', formatLocation(request.location))
                    }
                  />
                )}
              </div>
          ...
          <Card variant="vertical" title="">
            <div className="p-6 space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                {editingField === 'executionDateTime' &&
                viewType === 'admin' ? (
                  <div className="space-y-2">
                    <input
                      type="datetime-local"
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      handleStatusTransition(
                        e.target.value as RequestData['status'],
                      )
                    }
              ...
              <div className="space-y-3 text-sm">
                ...
                {request.estimatedDuration && (
                  <div>
                    ...
                    <Typography variant="p" size="sm">
                      {request.estimatedDuration} hora
                      {request.estimatedDuration !== 1 ? 's' : ''}
                    </Typography>
                  </div>
                )}
              </div>
