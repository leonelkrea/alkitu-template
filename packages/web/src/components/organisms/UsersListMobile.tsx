        ...
        <div className="bg-card border border-border rounded-lg p-4 space-y-4">
          <div className="space-y-3">
            ...
            <div>
              ...
              >
                <option value="all">
                  Todos ({getUsersCount('all', 'role')})
                </option>
                <option value="admin">
                  Administrador ({getUsersCount('admin', 'role')})
                </option>
                <option value="manager">
                  Manager ({getUsersCount('manager', 'role')})
                </option>
                <option value="employee">
                  Empleado ({getUsersCount('employee', 'role')})
                </option>
                <option value="client">
                  Cliente ({getUsersCount('client', 'role')})
                </option>
              </select>
            </div>
            ...
            <div>
              ...
              >
                <option value="all">
                  Todos ({getUsersCount('all', 'status')})
                </option>
                <option value="active">
                  Activos ({getUsersCount('active', 'status')})
                </option>
                <option value="inactive">
                  Inactivos ({getUsersCount('inactive', 'status')})
                </option>
              </select>
            </div>
          </div>
