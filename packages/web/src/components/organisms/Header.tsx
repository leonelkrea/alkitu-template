    ...
    <>
      ...
      >
        ...
        <div className="flex items-center space-x-4">
          ...
          <NotificationDot count={notificationsCount} variant="error" max={99}>
            <IconButton
              icon="Bell"
              iconOnly
              variant="ghost"
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        <Icon
                          ...
                          size="sm"
                          color={
                            currentRoute === item.id ? 'primary' : 'inherit'
                          }
                          className={
                            currentRoute === item.id ? 'text-primary' : ''
                          }
                        />
                        <Typography
                          variant="p"
                          ...
                          weight="medium"
                          className={
                            currentRoute === item.id ? 'text-white' : ''
                          }
                        >
                          {item.label}
                        </Typography>
