...
const WorkLocationsPage: React.FC<WorkLocationsPageProps> = ({
  ...
  const defaultLocations: Location[] = [
    ...
    },
    {
      ...
      address:
        'Polígono Industrial Les Planes, 08172 Sant Cugat del Vallès, Barcelona',
      type: 'warehouse',
      status: 'active',
      capacity: 50,
      currentOccupancy: 35,
      ...
      image:
        'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=400&h=200&fit=crop',
    ...
    },
    {
      ...
      address:
        'Parque Industrial PISA, Calle Tecnología, 41940 Tomares, Sevilla',
      type: 'factory',
      status: 'active',
      capacity: 80,
      currentOccupancy: 72,
    ...
    },
    {
      ...
      image:
        'https://images.unsplash.com/photo-1553413077-190dd305871c?w=400&h=200&fit=crop',
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <Typography variant="p" color="muted">
              Gestiona y selecciona las ubicaciones disponibles para solicitudes
              de servicio
            </Typography>
          </div>
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-3">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <div>
                            <Typography variant="p" size="sm" weight="medium">
                              {location.workingHours.start} -{' '}
                              {location.workingHours.end}
                            </Typography>
                            <Typography variant="p" size="xs" color="muted">
                              Horario
                            </Typography>
