...
const BrandingDemo: React.FC = () => {
  const { config, updateConfig, applyConfig, resetConfig, isCustomized } =
    useBranding();

  // Estado local para cambios en tiempo real (preview)
  const [previewConfig, setPreviewConfig] = useState(config);
  const [previewMode, setPreviewMode] = useState<'default' | 'custom'>(
    'default',
  );
          ...
          <div className="flex items-start space-x-3">
            ...
            <div className="space-y-2">
              ...
              <Typography variant="p" size="sm" className="text-blue-800">
                Los cambios que apliques aquí se reflejarán automáticamente en
                TODOS los templates y componentes del sistema. Esto incluye
                páginas de login, dashboard, sidebar, headers, footers y
                cualquier otro lugar donde aparezca el branding.
              </Typography>
            </div>
          </div>
        </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <Typography variant="p" size="sm" className="text-green-800">
                  Los cambios ahora se muestran en todos los templates y
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <Typography variant="p" size="xs" color="muted">
                  {isCustomized
                    ? 'Branding personalizado activo'
                    : 'Usando branding por defecto'}
                </Typography>
              </div>
            </div>
            <div className="flex items-center space-x-2">
              <div
                className={`w-2 h-2 rounded-full ${isCustomized ? 'bg-design-primary' : 'bg-muted-foreground'}`}
              ></div>
              <Typography variant="p" size="xs" color="muted">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Button
                    ...
                    disabled={
                      ...
                      !previewConfig.customText.primary
                    }
                  >
                    Vista previa
                  </Button>
                      ...
                      <div className="w-16 h-16 mx-auto bg-design-primary/10 rounded-lg flex items-center justify-center overflow-visible">
                        <svg
                          ...
                          dangerouslySetInnerHTML={{
                            __html: previewConfig.customSvg,
                          }}
                        />
                      </div>
                      <Typography variant="p" size="sm" color="primary">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <Button
                            ...
                            size="sm"
                            onClick={() =>
                              updatePreviewConfig({ iconScale: 1 })
                            }
                            className="text-xs px-2 py-1 h-auto"
                          >
                            100%
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center space-x-3">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              updatePreviewConfig({
                                iconOffsetX: parseInt(e.target.value),
                              })
                            }
                            className="flex-1 h-2 bg-neutral-200 rounded-lg appearance-none cursor-pointer"
                          />
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center space-x-3">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              updatePreviewConfig({
                                iconOffsetY: parseInt(e.target.value),
                              })
                            }
                            className="flex-1 h-2 bg-neutral-200 rounded-lg appearance-none cursor-pointer"
                          />
                  ...
                  <div className="grid grid-cols-5 gap-2">
                    {predefinedColors.map((color) => (
                      <button
                        ...
                        className={`w-full h-8 rounded border-2 transition-all ${previewConfig.textColors.primary === color.value ? 'border-design-primary' : 'border-neutral-300 hover:border-neutral-400'}`}
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
                  <div className="flex items-start space-x-2">
                    ...
                    <div>
                      ...
                      >
                        <strong>Nota:</strong> Los colores personalizados solo
                        se aplican al tema claro. En el tema oscuro, el texto se
                        adaptará automáticamente para mantener la legibilidad.
                      </Typography>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
                  <div className="flex items-center space-x-2">
                    ...
                    <Typography
                      ...
                      className="text-yellow-800"
                    >
                      Tienes cambios sin aplicar. Los cambios se aplicarán
                      globalmente al confirmar.
                    </Typography>
                  </div>
                </div>
              )}
                    ...
                    <div className="flex items-center justify-center space-x-4 text-xs text-muted-foreground">
                      <div className="flex items-center space-x-2">
                        <div
                          ...
                          style={{
                            backgroundColor: previewConfig.textColors.primary,
                          }}
                        ></div>
                        <span>Primario</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <div
                          className="w-3 h-3 rounded border border-neutral-300"
                          style={{
                            backgroundColor: previewConfig.textColors.secondary,
                          }}
                        ></div>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
          <div className="flex items-start space-x-3">
            ...
            <div className="space-y-2">
              ...
              <Typography variant="p" size="sm" className="text-blue-800">
                Al aplicar los cambios, el branding se actualizará
                automáticamente en:
              </Typography>
            </div>
          </div>
        ...
        <div className="bg-neutral-900 text-neutral-100 p-6 rounded-lg overflow-x-auto">
          <div className="space-y-4">
            <div className="text-neutral-400 text-sm">
              {/* El branding ahora es global y automático */}
            </div>
            <div>
              <span className="text-green-400">import</span> Brand{' '}
              <span className="text-green-400">from</span>{' '}
              <span className="text-yellow-400">
&apos;./src/components/atoms/Brand&apos;
              </span>
              ;
            </div>

            <div className="mt-6 text-neutral-400 text-sm">
              {/* Uso simple - usa automáticamente la configuración global */}
            </div>
            <div>
              &lt;<span className="text-blue-400">Brand</span>{' '}
              <span className="text-purple-400">variant</span>=
              <span className="text-yellow-400">&quot;horizontal&quot;</span>{' '}
              <span className="text-purple-400">size</span>=
              <span className="text-yellow-400">&quot;lg&quot;</span> /&gt;
            </div>

            <div className="mt-6 text-neutral-400 text-sm">
              {/* Los cambios aplicados aquí se reflejan automáticamente */}
            </div>
