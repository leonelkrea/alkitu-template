      ...
      <div className="border border-border rounded-lg overflow-hidden">
        <div className="bg-muted/30 p-4 border-b border-border">
          <Typography variant="p" size="sm" weight="medium">
            ...
            {isMobile ? 'ProfileFormMobile' : 'ProfileForm'}
          </Typography>
        </div>
      ...
      <div className="bg-card border border-border rounded-lg p-4 space-y-2">
        ...
        <ul className="space-y-1 pl-4">
          <li className="text-sm text-muted-foreground">
            • 📁 <code>ProfileForm.tsx</code> - Versión desktop optimizada
          </li>
          <li className="text-sm text-muted-foreground">
            • 📁 <code>ProfileFormMobile.tsx</code> - Versión móvil optimizada
          </li>
          <li className="text-sm text-muted-foreground">
            • 🔄 <code>useIsMobile()</code> - Hook para detectar dispositivo
          </li>
          <li className="text-sm text-muted-foreground">
            • 🎨 Componentes específicos (FormField vs FormFieldMobile)
          </li>
          <li className="text-sm text-muted-foreground">
