  ...
  const complexColumns: TableColumn[] = [
    ...
    },
    {
      ...
      render: {
        ...
        size: 'sm',
        onClick: (value, record) =>
          alert(`Contrato ${value} de ${record.name}`),
    ...
    <div className="space-y-8 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            ...
            <Typography variant="p" size="sm" className="text-blue-800">
              • <strong>Múltiples tipos de celda:</strong> texto, badges, chips,
              avatares, botones, iconos, fechas, números, progreso
              <br />• <strong>Renderizado personalizado:</strong> sistema
              flexible de renderizado por columna
              <br />• <strong>Acciones inteligentes:</strong> condicionales,
              tooltips, estados dinámicos
              <br />• <strong>Filtros avanzados:</strong> búsqueda, filtros
              rápidos, filtros múltiples
              <br />• <strong>Estilos configurables:</strong> tamaños, bordes,
              hover, striped
            </Typography>
          </div>
      ...
      {selectedExample === 'basic' && (
        <div className="space-y-4">
          ...
          <Typography variant="p" size="sm" color="muted">
            Tabla simple con texto, enlaces, badges y fechas. Incluye ordenación
            y paginación básica.
          </Typography>
      ...
      {selectedExample === 'advanced' && (
        <div className="space-y-4">
          ...
          <Typography variant="p" size="sm" color="muted">
            Incluye avatares con estado, chips con colores, números formateados,
            barras de progreso y fechas relativas.
          </Typography>
      ...
      {selectedExample === 'complex' && (
        <div className="space-y-4">
          ...
          <Typography variant="p" size="sm" color="muted">
            Ejemplo completo con renderizadores personalizados, iconos
            interactivos, listas de tags, botones condicionales y múltiples
            tipos de datos.
          </Typography>
          ...
          {[
            {
              ...
              title: 'Texto',
              description:
                'Renderizado de texto con opciones de tipografía, truncado y colores.',
            ...
            },
            {
              ...
              title: 'Badges',
              description:
                'Etiquetas de estado con mapeo de valores y variantes.',
            ...
            },
            {
              ...
              title: 'Chips',
              description:
                'Chips removibles con colores y variantes personalizables.',
            ...
            },
            {
              ...
              title: 'Avatares',
              description:
                'Avatares con imágenes, fallbacks, estados y nombres.',
            ...
            },
            {
              ...
              title: 'Botones',
              description:
                'Botones interactivos con estados, tooltips y acciones.',
            ...
            >
              ...
              <Typography
                variant="p"
                size="xs"
                className="text-primary bg-primary/10 px-2 py-1 rounded"
              >
                {renderer.example}
              </Typography>
            </div>
