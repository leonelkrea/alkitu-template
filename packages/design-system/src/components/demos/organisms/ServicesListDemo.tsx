...
const ServicesListDemo: React.FC = () => {
  ...
  const sampleServices: Service[] = [
    {
      ...
      description: 'Servicio completo de pintura para interiores y exteriores de viviendas.',
      category: 'Hogar',
      image: {
      ...
      status: 'active',
      features: ['Pintura interior', 'Pintura exterior', 'Preparación de superficie'],
    ...
    },
    {
      ...
      description: 'Servicio profesional de mudanzas locales e internacionales.',
      category: 'Logística',
      image: {
        src: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&h=300',
        alt: 'Mudanzas'
      ...
      status: 'maintenance',
      features: ['Embalaje profesional', 'Transporte seguro', 'Seguro incluido'],
    ...
    },
    {
      ...
      description: 'Consultoría y diseño de espacios interiores personalizados.',
      category: 'Diseño',
      image: {
  ...
  const handleServiceClick = (serviceId: string) => {
    ...
    alert(`Servicio seleccionado: ${sampleServices.find(s => s.id === serviceId)?.title}`);
  };
    ...
    <div className="space-y-8 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            ...
            <Typography variant="p" size="sm" className="text-blue-800">
              • <strong>Grid responsivo:</strong> 2-6 columnas según el tamaño de pantalla<br/>
              • <strong>Cards simples:</strong> Solo imagen, título y categoría<br/>
              • <strong>Filtros avanzados:</strong> Por estado y categoría con contadores<br/>
              • <strong>Stats footer:</strong> Resumen visual de estados
            </Typography>
          </div>
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-4">
            ...
            <Typography variant="p" size="sm" className="text-green-800">
              • <strong>Información completa:</strong> Descripción, precio, rating, características<br/>
              • <strong>Múltiples vistas:</strong> Grid y lista intercambiables<br/>
              • <strong>Filtros completos:</strong> Todos los metadatos disponibles<br/>
              • <strong>Cards expandidas:</strong> Información detallada visible
            </Typography>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="bg-card border border-border rounded-lg p-4">
          ...
          <Typography variant="p" size="xs" color="muted" className="mt-1">
            ...
            {sampleServices.filter(s => s.status === 'maintenance').length} en mantenimiento, {' '}
      ...
      <div className="bg-neutral-50 p-6 rounded-lg border border-border">
        <div className="mb-4 text-center">
          <Typography variant="p" size="sm" weight="medium" className="bg-white px-3 py-1 rounded-full border">
            {isMobile ? '📱 Versión Móvil' : '🖥️ Versión Desktop'} - Componente: {isMobile ? 'ServicesListMobile' : 'ServicesList'}
          </Typography>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-start space-x-2">
                ...
                <div>
                  <Typography variant="p" size="sm" weight="medium">Grid Ultra Responsivo</Typography>
                  <Typography variant="p" size="xs" color="muted">2 cols (móvil) &rarr; 6 cols (4K), adaptación automática</Typography>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-2">
                <div className="w-1.5 h-1.5 bg-design-primary rounded-full mt-2"></div>
                <div>
                  <Typography variant="p" size="sm" weight="medium">Cards Simples</Typography>
                  <Typography variant="p" size="xs" color="muted">Imagen + título + categoría, diseño limpio</Typography>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-2">
                <div className="w-1.5 h-1.5 bg-design-primary rounded-full mt-2"></div>
                <div>
                  <Typography variant="p" size="sm" weight="medium">Filtros con Contadores</Typography>
                  <Typography variant="p" size="xs" color="muted">Badges que muestran número de servicios por estado</Typography>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-2">
                <div className="w-1.5 h-1.5 bg-design-primary rounded-full mt-2"></div>
                <div>
                  <Typography variant="p" size="sm" weight="medium">Stats Footer</Typography>
                  <Typography variant="p" size="xs" color="muted">Resumen visual con dots de colores por estado</Typography>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-2">
                <div className="w-1.5 h-1.5 bg-design-primary rounded-full mt-2"></div>
                <div>
                  <Typography variant="p" size="sm" weight="medium">Hover Effects</Typography>
                  <Typography variant="p" size="xs" color="muted">Transiciones suaves y scale en imágenes</Typography>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-start space-x-2">
                ...
                <div>
                  <Typography variant="p" size="sm" weight="medium">Cards Completas</Typography>
                  <Typography variant="p" size="xs" color="muted">Descripción, precio, rating, características</Typography>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-2">
                <div className="w-1.5 h-1.5 bg-secondary rounded-full mt-2"></div>
                <div>
                  <Typography variant="p" size="sm" weight="medium">Toggle Grid/Lista</Typography>
                  <Typography variant="p" size="xs" color="muted">Cambio entre vista de grid y lista horizontal</Typography>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-2">
                <div className="w-1.5 h-1.5 bg-secondary rounded-full mt-2"></div>
                <div>
                  <Typography variant="p" size="sm" weight="medium">Filtros Avanzados</Typography>
                  <Typography variant="p" size="xs" color="muted">Por estado, categoría, con dropdown de categorías</Typography>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-2">
                <div className="w-1.5 h-1.5 bg-secondary rounded-full mt-2"></div>
                <div>
                  <Typography variant="p" size="sm" weight="medium">Metadatos Visibles</Typography>
                  <Typography variant="p" size="xs" color="muted">Precio, calificación, características destacadas</Typography>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-2">
                <div className="w-1.5 h-1.5 bg-secondary rounded-full mt-2"></div>
                <div>
                  <Typography variant="p" size="sm" weight="medium">Estados Visuales</Typography>
                  <Typography variant="p" size="xs" color="muted">Badges de estado con colores diferenciados</Typography>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              ...
              <div className="space-y-2 text-sm">
                <div><code className="bg-neutral-200 px-1 rounded">variant</code>: 'gallery' | 'detailed'</div>
                <div><code className="bg-neutral-200 px-1 rounded">showFilters</code>: boolean</div>
                <div><code className="bg-neutral-200 px-1 rounded">showHeader</code>: boolean</div>
                <div><code className="bg-neutral-200 px-1 rounded">services</code>: Service[]</div>
              </div>
            </div>
            
            <div>
              <Typography variant="h4" className="mb-3">Callbacks</Typography>
              <div className="space-y-2 text-sm">
                <div><code className="bg-neutral-200 px-1 rounded">onServiceClick</code>: (id) =&gt; void</div>
                <div><code className="bg-neutral-200 px-1 rounded">onCreateService</code>: () =&gt; void</div>
              </div>
            </div>
            
            <div>
              <Typography variant="h4" className="mb-3">Responsive Grid</Typography>
              <div className="space-y-2 text-sm">
                <div><strong>Gallery:</strong> 2&rarr;3&rarr;4&rarr;5&rarr;6 cols</div>
                <div><strong>Detailed:</strong> 1&rarr;2&rarr;3 cols</div>
                <div><strong>Breakpoints:</strong> sm, md, lg, xl, 2xl</div>
              </div>
            </div>
          </div>
        </div>
