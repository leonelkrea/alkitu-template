...
const ComponentSpecs: React.FC<ComponentSpecsProps> = ({ component }) => {
  ...
  const getCategoryColor = (category: string) => {
    switch (category) {
      ...
      case 'Atoms': return 'success';
      case 'Molecules': return 'warning';
      case 'Organisms': return 'secondary';
      case 'Templates': return 'neutral';
  ...
  const getCategoryIcon = (category: string) => {
    switch (category) {
      ...
      case 'Atoms': return 'Circle';
      case 'Molecules': return 'Hexagon';
      case 'Organisms': return 'Layers';
      case 'Templates': return 'LayoutGrid';
          ...
          <tbody>
            {Object.entries(component.props).map(([propName, propType]) => (
              <tr key={propName} className="border-b border-border/50">
                ...
                <td className="py-3 px-4">
                  <Typography variant="p" size="sm" color="muted" className="font-mono">
                    {String(propType)}
                  </Typography>
                </td>
                <td className="py-3 px-4">
  ...
  return (
    <div className="space-y-8">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-4">
            {component.examples.map((example, index) => (
              <div key={index} className="bg-neutral-900 text-neutral-100 rounded-lg p-4 overflow-x-auto">
      ...
      {(component.category === 'Organisms' || component.category === 'Templates') && (
        <div className="space-y-4">
          <div className="flex items-center space-x-2">
          ...
          <div className="bg-accent/10 border border-accent/20 rounded-lg p-6">
            <Typography variant="p" size="sm" className="mb-4">
              Este {component.category === 'Organisms' ? 'organismo' : 'template'} está construido usando el principio de Atomic Design:
            </Typography>
