...
import ComponentDemo from "./src/components/system/ComponentDemo";
import ComponentSpecs from "./src/components/system/ComponentSpecs";
import {
  componentsData,
  componentCategories,
  ComponentKey,
} from "./src/data/componentsData";
...
export default function App() {
  ...
  const currentComponentHasMobile =
    componentsData[selectedComponent]?.hasMobileVersion ||
    false;
  ...
  const getComponentPath = (
    ...
    if (componentName === "Brand") {
      return "./src/components/atoms/Brand.tsx";
    }
    ...
    const pathPrefix =
      categoryToPath[
        component.category as keyof typeof categoryToPath
      ];
  ...
  const filteredCategories = useMemo(() => {
    ...
    Object.entries(componentCategories).forEach(
      ([category, components]) => {
  ...
  const handleComponentSelect = (component: ComponentKey) => {
    ...
    const hasMobile =
      componentsData[component]?.hasMobileVersion || false;
                ...
                {Object.keys(filteredCategories).length > 0 ? (
                  ...
                  <div className="text-center py-12">
                    ...
                    <Typography
                      ...
                      className="mb-4"
                    >
                      No hay componentes que coincidan con "
                      {searchTerm}"
                    </Typography>
                    <Button
                      variant="outline"
        ...
        <div className="flex-1 flex flex-col">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      {currentComponentHasMobile && (
                        <div className="flex items-center space-x-2 text-xs text-muted-foreground">
                          ...
                          <span>
                            Adaptaciones móviles disponibles
                          </span>
                        </div>
                      )}
                    </div>
                  ...
                  <div className="border-t border-border bg-neutral-50 px-4 py-3 rounded-b-lg">
                    ...
                    <div className="mt-2 flex items-center space-x-4 text-xs text-muted-foreground">
                      ...
                      <span>
                        Categoría:{" "}
                        {
                          componentsData[selectedComponent]
                            ?.category
                        }
                      </span>
                      <span>•</span>
          ...
          <footer className="bg-card border-t border-border px-8 py-2 flex items-center justify-between">
            <div className="flex items-center space-x-4 text-sm text-muted-foreground">
              ...
              <span>•</span>
              <span>
                {Object.keys(componentsData).length} componentes
              </span>
              <span>•</span>
              <span>
                {
            ...
            <div className="flex items-center space-x-2 text-sm text-muted-foreground">
              ...
              <span>
                Vista{" "}
                {viewMode === "mobile" ? "Móvil" : "Escritorio"}
              </span>
            </div>
          </footer>
        </div>
