    ...
    <div className="space-y-6">
      ...
      <div className="border border-border rounded-lg overflow-hidden">
        <div className="bg-muted/30 p-4 border-b border-border">
          <Typography variant="p" size="sm" weight="medium">
            {isMobile ? '📱 Versión Móvil' : '🖥️ Versión Desktop'} - Componente: {isMobile ? 'UsersListMobile' : 'UsersList'}
          </Typography>
        </div>
      ...
      <div className="bg-card border border-border rounded-lg p-4 space-y-2">
        ...
        <ul className="space-y-1 pl-4">
          <li className="text-sm text-muted-foreground">• 📱 Móvil: Cards verticales, filtros colapsables, avatares prominentes</li>
          <li className="text-sm text-muted-foreground">• 🖥️ Desktop: Grid compacto, filtros inline, información condensada</li>
          <li className="text-sm text-muted-foreground">• 🔍 Búsqueda optimizada para cada pantalla</li>
          <li className="text-sm text-muted-foreground">• ⚡ Acciones táctiles vs hover interactions</li>
          <li className="text-sm text-muted-foreground">• 🎨 Espaciado y tipografía específicos por dispositivo</li>
        </ul>
      </div>
    </div>
  );
