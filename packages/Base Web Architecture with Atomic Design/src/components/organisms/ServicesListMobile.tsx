    ...
    <div className={`space-y-4 ${className}`} {...props}>
          ...
          {filteredServices.map((service) => (
            ...
            >
              <div className="p-4 space-y-3">
                ...
                {/* Service Description */}
                <Typography variant="p" size="sm" color="muted" className="line-clamp-3">
                  {service.description}
                </Typography>
                ...
                <div className="flex items-center justify-between pt-3 border-t border-border">
                  {service.price ? (
                    <Typography variant="p" size="sm" weight="bold" className="text-primary">
                  ...
                  {service.rating && (
                    <div className="flex items-center space-x-1">
                      <Icon name="Star" size="xs" className="text-warning fill-current" />
      ...
      {filteredServices.length > 0 && (
        <div className="bg-card border border-border rounded-lg p-4">
          <Typography variant="p" size="sm" weight="medium" className="mb-3 text-center">
            Resumen por estado
          </Typography>
