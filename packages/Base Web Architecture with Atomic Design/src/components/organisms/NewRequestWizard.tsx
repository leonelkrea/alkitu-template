        ...
        return (
          <div className="space-y-6">
            ...
            <div className="bg-accent/50 p-6 rounded-lg space-y-4">
              <div>
                <Typography variant="p" size="sm" color="muted">Título:</Typography>
                <Typography variant="p" weight="medium">{formData.title}</Typography>
              </div>
              
              <div>
                <Typography variant="p" size="sm" color="muted">Descripción:</Typography>
