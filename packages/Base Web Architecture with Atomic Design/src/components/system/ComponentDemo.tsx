...
import DashboardSummary, { DashboardMetric } from '../organisms/DashboardSummary';
...
const ComponentDemo: React.FC<ComponentDemoProps> = ({ 
      ...
      case 'ServiceCard':
        return (
          <div className="p-4 space-y-4">
            ...
            <Typography variant="p" size="sm" color="muted">
              Misma instancia de ServiceCard con precio prominente y layout vertical
            </Typography>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                {[
                  ...
                  { icon: 'Settings', label: 'Configuración', description: 'Preferencias y ajustes' },
                  { icon: 'Bell', label: 'Notificaciones', description: 'Gestionar alertas', badge: '3' },
                  { icon: 'HelpCircle', label: 'Ayuda y Soporte', description: 'Centro de ayuda' },
                  { icon: 'LogOut', label: 'Cerrar Sesión', description: 'Salir de la aplicación', variant: 'destructive' }
                ].map((item, index) => (
                  <Button
                    key={index}
                    variant="ghost"
                  ...
                  >
                    ...
                    <div className="flex-1 text-left">
                      ...
                      <Typography variant="p" size="xs" color="muted" className="block">
                        {item.description}
                      </Typography>
                    </div>
                    {item.badge && (
      ...
      case 'ToggleSwitch':
        return (
          <div className="p-4 space-y-4">
            ...
            <Typography variant="p" size="sm" color="muted">
              Misma instancia de ToggleSwitch con área de toque expandida para móvil
            </Typography>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-4">
                  <div className="flex items-center p-4 bg-card border border-border rounded-lg touch-manipulation">
                    <Icon name="Volume2" size="sm" className="mr-3 text-primary" />
          ...
          <div className="h-full">
            ...
            <div className="p-4 pb-20">
              ...
              <Typography variant="p" size="sm" color="muted" className="mb-6">
                Sidebar se convierte en Bottom Navigation usando las mismas instancias
              </Typography>
                ...
                metrics={[
                  {
                    ...
                    value: 24,
                    change: { value: 12, type: "increase", period: "último mes" },
                    icon: "FileText",
                    color: "primary",
                  ...
                  },
                  {
                    ...
                    value: 8,
                    change: { value: 5, type: "decrease", period: "semana pasada" },
                    icon: "Clock",
                    color: "warning",
                  ...
                  },
                  {
                    ...
                    value: 16,
                    change: { value: 8, type: "increase", period: "último mes" },
                    icon: "CheckCircle",
                    color: "success",
                  ...
                  },
                  {
                    ...
                    value: 12,
                    change: { value: 15, type: "increase", period: "último mes" },
                    icon: "Check",
                    color: "secondary",
              ...
              <div className="bg-card border border-border rounded-lg overflow-hidden">
                ...
                <div className="p-4 space-y-4">
                  <div>
                    ...
                    <Typography variant="p" size="sm">
                      Necesito una laptop nueva para el proyecto de desarrollo web que estamos iniciando.
                    </Typography>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between">
                        <Typography variant="p" size="sm" color="muted">Tipo:</Typography>
                        <Typography variant="p" size="sm">IT Equipment</Typography>
                      </div>
                      <div className="flex justify-between">
                        <Typography variant="p" size="sm" color="muted">Solicitante:</Typography>
                        <Typography variant="p" size="sm">Ana García</Typography>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-card border border-border rounded-lg p-4">
                <div className="flex items-center justify-between mb-4">
                  <Typography variant="h4" weight="medium">Paso 2 de 4</Typography>
                  <Typography variant="p" size="sm" color="muted">50%</Typography>
                </div>
                  ...
                  <div key={request.id} className="bg-card border border-border rounded-lg p-4">
                    <div className="flex items-start justify-between mb-3">
                      ...
                      <Badge 
                        ...
                        size="sm"
                      >
                        {request.status === 'pending' ? 'Pendiente' : 'Aprobado'}
                      </Badge>
                    </div>
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between">
                        <Typography variant="p" size="sm" color="muted">Tipo:</Typography>
                        <Typography variant="p" size="sm">{request.requestType}</Typography>
                      </div>
                      <div className="flex justify-between">
                        <Typography variant="p" size="sm" color="muted">Fecha:</Typography>
                        <Typography variant="p" size="sm">{request.requestDate}</Typography>
                      </div>
                      <div className="flex justify-between">
                        <Typography variant="p" size="sm" color="muted">Prioridad:</Typography>
                        <Badge variant={request.priority === 'high' ? 'error' : 'warning'} size="sm">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <label className="flex items-center space-x-2">
                      ...
                      <Typography variant="p" size="sm">Recordarme</Typography>
                    </label>
      ...
      case 'Header':
        return (
          <div className="space-y-4">
            ...
            <Typography variant="p" size="sm" color="muted">
              Header simplificado: Menú + Logo + Notificaciones. El menú despliega drawer con navegación completa.
            </Typography>
            ...
            <div className="space-y-4">
              ...
              {/* Example of mobile menu content */}
              <div className="bg-card border border-border rounded-lg p-4">
                <Typography variant="h4" weight="medium" className="mb-3">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span>Solicitudes (12 pendientes)</span>
                  </div>
                  <div className="flex items-center space-x-2">
            ...
            <div className="p-4 bg-accent rounded-lg">
              ...
              <div className="space-y-1">
                <Typography variant="p" size="sm">
                  • Solo 3 elementos: Menú + Logo + Notificaciones
                </Typography>
                <Typography variant="p" size="sm">
                  • Menú lateral con Sheet/Drawer component
                </Typography>
                <Typography variant="p" size="sm">
                  • Buscador integrado dentro del menú
                </Typography>
                <Typography variant="p" size="sm">
      ...
      case 'DashboardSummary':
        return (
          <div className="p-4 space-y-4">
            ...
            <Typography variant="p" size="sm" color="muted">
              Dashboard optimizado para móvil con grid de 1 columna y métricas más grandes
            </Typography>
            ...
            <div className="space-y-6">
              <DashboardSummary
                ...
                onMetricClick={(metricId) => console.log('Metric clicked:', metricId)}
                className="grid grid-cols-1 gap-4" // Mobile: 1 column only
              />
            </div>
            ...
            <div className="p-4 bg-accent rounded-lg">
              ...
              <div className="space-y-1">
                <Typography variant="p" size="sm">
                  • Grid de 1 columna para mejor legibilidad
                </Typography>
                <Typography variant="p" size="sm">
                ...
                <Typography variant="p" size="sm">
                  • Touch-friendly con gestos de toque optimizados
                </Typography>
              </div>
            </div>
          </div>
      ...
      case 'RequestsList':
        return (
          <div className="p-4 space-y-4">
            ...
            <Typography variant="p" size="sm" color="muted">
              Lista de solicitudes optimizada para navegación móvil con controles simplificados
            </Typography>
            ...
            <div className="space-y-4">
              <RequestsList
                ...
                onNewRequest={() => console.log('New request')}
                onFilterChange={(filters) => console.log('Filters changed:', filters)}
                className="space-y-3" // Mobile spacing
              />
            </div>
            ...
            <div className="p-4 bg-accent rounded-lg">
              ...
              <div className="space-y-1">
                ...
                <Typography variant="p" size="sm">
                  • Controles de filtrado colapsables en drawer
                </Typography>
                <Typography variant="p" size="sm">
                  • Botón FAB para nueva solicitud
                </Typography>
                <Typography variant="p" size="sm">
                  • Swipe actions para acciones rápidas
                </Typography>
      ...
      default:
        return (
          <div className="p-4">
            ...
            <Typography variant="p" size="sm" color="muted">
              Este componente incluye adaptaciones específicas para móvil usando las mismas instancias del design system.
            </Typography>
          </div>
        );
    }
  ...
  const renderComponent = () => {
    ...
    if (viewMode === 'mobile') {
      const componentData = require('../../data/componentsData').componentsData[componentName];
