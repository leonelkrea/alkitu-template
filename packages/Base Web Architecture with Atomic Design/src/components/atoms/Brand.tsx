...
const Brand: React.FC<BrandProps> = ({
  ...
  const finalScale = overrideScale !== undefined ? overrideScale : config.iconScale;
  const finalOffsetX = overrideOffsetX !== undefined ? overrideOffsetX : config.iconOffsetX;
  const finalOffsetY = overrideOffsetY !== undefined ? overrideOffsetY : config.iconOffsetY;
            ...
            <svg
              ...
              style={{
                ...
                filter: color === 'white' ? 'brightness(0) invert(1)' : 
                       color === 'monochrome' ? 'brightness(0)' : 'none',
      ...
      >
        <Icon 
          ...
          className={
            ...
            color === 'monochrome' ? 'text-neutral-900' :
            'text-neutral-900'
          }
        />
      </div>
      ...
      <div className={centerClasses}>
        ...
        {finalText.secondary && (
          <Typography 
            ...
            style={useCustomColors ? { 
              color: finalTextColors.secondary,
              textAlign: variant === 'vertical' ? 'center' : undefined 
            } : undefined}
          >
            {finalText.secondary}
